...
parser.add_argument('-dmax', action="store", dest="max_score", type=int, default=2, help="Maximum number of gaps/substitutions allowed in the inexact overlap between reads")
